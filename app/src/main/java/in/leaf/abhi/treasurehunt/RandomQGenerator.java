...
class RandomQGenerator {
    ...
    public void generate(int bound,int size,int seed) {  //bound must be greater than size
        Random r = new Random(seed);
        this.size=size;
        qSet=new int[size];
        Boolean stored;
        while ((stored = store(r.nextInt(bound - 1))) != null) ;
    }
    public int[] getqSet() { // This function will return the Question Set generated by the g
